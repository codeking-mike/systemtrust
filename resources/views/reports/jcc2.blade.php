      ...
      <div class="col-md-8">
        <div class="card">
          ...
          <div class="card-body">
            ...
            @endif
            <form action="/reports/create/jcc2" method="post" enctype="multipart/form-data">
                @csrf
              <div class="row">
                ...
                <div class="col-md-12 row">
                    ...
                    <input type="tex" name='equipment_brand' class="form-control" value="{{$machine->ups_brand}}">
                    ...
                    <input type="tex" name='equipment_capacity' class="form-control" value="{{$machine->ups_capacity}}">
                ...
                <div class="col-md-12 row">
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" name="battery_spec" class="form-control" value="{{$machine->battery_capacity}}">
                   
                  </div>
                  <div class="form-group col-md-4">
                    <label for="example-text-input" class="form-control-label">Battery Quantity</label>
                    
                    <input type="text" name="battery_qty" class="form-control" value="{{$machine->number_of_batteries}}">
