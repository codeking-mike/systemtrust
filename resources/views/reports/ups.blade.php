              ...
              <table class="table align-items-center mb-0" id="myTable">
                <thead>
                  <tr>
                    ...
                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">UPS Brand / Capacity</th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <td>
                        <p class="text-xs font-weight-bold mb-0 text-center">{{$machine['ups_brand']}} / {{$machine['ups_capacity']}}</p>
                    ...
                    <td class="align-middle">
                      <a href="/jcc2/{{$machine->id}}" class="btn btn-success" data-toggle="tooltip" data-original-title="Edit Machine">
                        Submit Report
                      </a>
                    </td>
                  </tr>
