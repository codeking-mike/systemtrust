          ...
          <div class="card">
            <div class="card-body row">
              <form action="/attendance/checkin" method="post" class="col-md-4 " style="max-width: 50%;padding:0px">
                ...
                <input type="hidden" name="time_in" value="{{time()}}" />
              <button class="btn btn-primary" type="submit">
                <i class="ni ni-world text-lg opacity-10" aria-hidden="true"></i>Check-in
              </button>
              </form>
              <form action="/attendance/checkout" method="post" class="col-md-4" style="max-width: 50%;padding:0px">
                @csrf
              ...
              <div class="card-body p-3">
                <ul class="list-group">
                  ...
                  <li class="list-group-item border-0 d-flex justify-content-between ps-0 border-radius-lg">
                    ...
                    <div class="d-flex">
                      <button class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto"><i class="ni ni-bold-right" aria-hidden="true"></i>Okay</button>
                    </div>
                  </li>
                </ul>
              </div>
